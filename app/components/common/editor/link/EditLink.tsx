...
const EditLink: FC<Props> = ({editor}): JSX.Element => {
  ...
  const handleSubmit = ({url , openInNewTab}: linkOpition) => {
    editor
    .chain()
    .focus()
    .unsetLink()
  ...
  return (
    <BubbleMenu 
      ...
      />  
      {!showEditForm && (<div className="rounded bg-primary dark:bg-primary-dark 
      text-primary-dark dark:text-primary shadow-secondary-dark 
      shadow-md p-3 flex items-center space-x-6 z-50">
